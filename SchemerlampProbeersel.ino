...
IPAddress local_Ip(192,168,10,22); //wanneer de pi dhcp zou hebben zou dit niet nodig zijn en is de code helemaal identiek op beide wemossen
IPAddress gateway(192,168,10,1); //Dit zal vast wel elke keer aangepast moeten worden
...
void MovementHandler() // Afhandelen van bewegingsregistratie
{
  ...
  {
    Serial.println("Someone is home!");
